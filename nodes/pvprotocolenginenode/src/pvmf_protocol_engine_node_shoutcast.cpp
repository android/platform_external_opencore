...
////////////////////////////////////////////////////////////////////////////////////
//////	ShoutcastContainerFactory implementation
////////////////////////////////////////////////////////////////////////////////////
ProtocolContainer* ShoutcastContainerFactory::create(PVMFProtocolEngineNode *aNode)
{
...
bool ShoutcastContainer::createProtocolObjects()
{
    ...
    // re-create iNode->iProtocol
    if (iNode->iProtocol) OSCL_DELETE(iNode->iProtocol);
    iNode->iProtocol = OSCL_NEW(ShoutcastStreaming, ());
    if (iNode->iProtocol == NULL) return false;

    // re-create iNode->iDownloadControl
    if (iNode->iDownloadControl) OSCL_DELETE(iNode->iDownloadControl);
    iNode->iDownloadControl = OSCL_NEW(ShoutcastControl, ());
    return (iNode->iDownloadControl != NULL);
}
...
PVMFStatus ShoutcastContainer::doStop()
{
    ...
    iNode->iNodeOutput->seekDataStream(0);
