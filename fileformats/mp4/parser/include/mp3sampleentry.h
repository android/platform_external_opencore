...
#ifndef MP3SAMPLEENTRY_H_INCLUDED
#define MP3SAMPLEENTRY_H_INCLUDED
...
class Mp3SampleEntry : public SampleEntry
{

    public:
        Mp3SampleEntry(MP4_FF_FILE *fp, uint32 size, uint32 type);
        virtual ~Mp3SampleEntry();
